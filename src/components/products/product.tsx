...
export default function Product({
  ...
  return (
    <li className="border border-gray-300 rounded-[var(--radius)] overflow-hidden transition-all duration-300 hover:border-[var(--primary-alt)] hover:shadow-lg hover:-translate-y-1 cursor-pointer">
      <Link href={`/products/${slug || id}`}>
        ...
        <div className="p-3">
          ...
          <p className="text-[var(--primary-alt)] text-lg font-semibold">
            ${price?.toFixed(2)}
          </p>
        </div>
      </Link>
